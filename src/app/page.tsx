    ...
    <main className="relative flex h-[100dvh] w-full flex-col overflow-hidden bg-black select-none">
      ...
      <div className="relative z-10 flex h-full min-h-0 w-full flex-col pb-[max(4.2rem,calc(env(safe-area-inset-bottom)+3.7rem))]">
        ...
        <section
          ...
          className="relative z-20 mx-auto mt-2 h-[clamp(220px,30dvh,310px)] w-[calc(100%-1.25rem)] max-w-xl flex-none overflow-hidden rounded-2xl border border-cyan-500/20 bg-black/65 shadow-[0_0_20px_rgba(0,242,234,0.08)]"
        >
          <div className="absolute inset-0 bg-gradient-to-b from-cyan-950/8 via-black/15 to-black/45" aria-hidden="true" />
        </section>
